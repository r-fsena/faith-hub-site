...
export const HomePage: React.FC<HomePageProps> = ({ openWhatsAppLead }) => {
          ...
          {activeTab === 'pwa' && (
            <div className="features-grid animate-fade-in-up">
              ...
              <div className="feature-card">
                ...
                <a href="/biblia-offline" className="feature-link">Bíblia 100% offline em detalhes →</a>
              </div>
              ...
              <div className="feature-card">
                ...
                <a href="/kids" className="feature-link">Ver como funciona o Totem Kids →</a>
              </div>
              ...
              <div className="feature-card">
                ...
                <a href="/celulas" className="feature-link">Ver gestão de células e escalas →</a>
              </div>
              ...
              <div className="feature-card">
                ...
                <a href="/dizimos-pix" className="feature-link">Conhecer o PIX por congregação →</a>
              </div>
          ...
          {activeTab === 'studio' && (
            <div className="features-grid animate-fade-in-up">
              ...
              <div className="feature-card">
                ...
                <a href="/kids" className="feature-link">Conhecer o Módulo Kids completo →</a>
              </div>
              ...
              <div className="feature-card">
                ...
                <a href="/multi-campus" className="feature-link">Conhecer a governança multi-campi →</a>
              </div>
              ...
              <div className="feature-card">
                ...
                <a href="/celulas" className="feature-link">Conhecer o Cell Workspace Studio →</a>
              </div>
